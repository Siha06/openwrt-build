sed -i 's/192.168.6.6/192.168.6.6/g' package/base-files/files/bin/config_generate
sed -i "s/192\.168\.[0-9]*\.[0-9]*/192.168.6.6/g" $(find ./feeds/luci/modules/luci-mod-system/ -type f -name "flash.js")
