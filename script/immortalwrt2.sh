sed -i 's/192.168.1.1/192.168.5.99/g' package/base-files/files/bin/config_generate
sed -i "s/192\.168\.[0-9]*\.[0-9]*/192.168.5.99/g" $(find ./feeds/luci/modules/luci-mod-system/ -type f -name "flash.js")
