...
sed -i '$a src/gz kmods https://mirrors.pku.edu.cn/openwrt/releases/24.10.8/targets/ramips/mt7621/kmods/6.6.144-1-f31f6f85a36836e510d64a18a9a5f1bf' /etc/opkg/distfeeds.conf
sed -i '$a src/gz mt7621pkg https://mirrors.pku.edu.cn/openwrt/releases/24.10.8/targets/ramips/mt7621/packages/' /etc/opkg/distfeeds.conf
