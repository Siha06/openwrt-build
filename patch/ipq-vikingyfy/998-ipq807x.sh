...
sed -i '$a http://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq807x/kmods/6.12.35-1-e7bb587fd1070df0ec93f514bf1e0f0f/packages.adb' /etc/apk/repositories.d/customfeeds.list
