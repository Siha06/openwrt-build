...
sed -i '$a https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq60xx/kmods/6.6.83-1-6466bd46a803e6572a94d1ed46a0536e/packages.adb' /etc/apk/repositories.d/customfeeds.list
# 设置所有网口可访问网页终端
